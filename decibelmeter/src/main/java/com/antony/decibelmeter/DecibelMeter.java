...
public class DecibelMeter extends View {
    ...
    public static final float NEEDLE_WIDTH = 0.015f;
    public static final float NEEDLE_HEIGHT = 0.24f;
...
//    }
    ...
    public Paint getDefaultOuterRimPaint() {
        ...
        final LinearGradient verticalGradient = new LinearGradient(mOuterRimRect.left, mOuterRimRect.top, mOuterRimRect.left,
                mOuterRimRect.bottom, Color.rgb(255, 255, 255), Color.rgb(84, 90, 100), android.graphics.Shader.TileMode.REPEAT);
        ...
        final BitmapShader aluminiumTile = new BitmapShader(bitmap, android.graphics.Shader.TileMode.REPEAT, android.graphics.Shader.TileMode.REPEAT);
    ...
    public Paint getDefaultFacePaint() {
        ...
        paint.setShader(new RadialGradient(0.5f, 0.5f, mFaceRect.width() / 2, new int[]{Color.rgb(50, 132, 206), Color.rgb(36, 89, 162),
                Color.rgb(27, 59, 131)}, new float[]{0.5f, 0.96f, 0.99f}, android.graphics.Shader.TileMode.MIRROR));
        return paint;
    }
    ...
    public Paint getDefaultFaceShadowPaint() {
        ...
        paint.setShader(new RadialGradient(0.5f, 0.5f, mFaceRect.width() / 2.0f, new int[]{Color.argb(60, 40, 96, 170),
                ...
                new float[]{0.60f, 0.85f, 0.96f, 0.99f}, android.graphics.Shader.TileMode.MIRROR));
        return paint;
    }
...
//            canvas.drawPath(mNeedleLeftPath, mNeedleLeftPaint);
            ...
            canvas.drawCircle(0.5f, 0.5f, 0.045f, mNeedleScrewPaint);
    ...
    private void drawPlayButton(Canvas canvas) {
        float x = 0.5f, y = 0.5f;
        Path play = new Path();
        play.moveTo(x - 0.01f, y - 0.015f);
        play.lineTo(x - 0.01f, y + 0.015f);
        play.lineTo(x + 0.02f, y);

        final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint.setColor(Color.parseColor("#f7931e"));
